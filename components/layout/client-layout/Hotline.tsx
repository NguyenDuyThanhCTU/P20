  ...
  return (
    <div className="fixed bottom-7 right-10  box-border flex flex-col gap-5">
      <Link
        ...
        className="p:flex items-center d:hidden"
      >
        <div className="h-14 w-14 p-2 bg-blue-500 border-white border flex items-center rounded-full justify-center">
          <FaFacebookF className="text-white text-[40px]" />
        </div>
      </Link>
      <Link href={`https://${SocialMedia[0]}`} className="flex items-center ">
        <div className="h-14 w-14 bg-white border border-blue-500 text-blue-500 flex items-center rounded-full justify-center">
